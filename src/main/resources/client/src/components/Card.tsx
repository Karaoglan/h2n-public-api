...
export const Card: FunctionComponent<H2NPost> = ({id, summarizeText, postText, clickHandler}) => {
  return (
    <div onClick={clickHandler} className="w-12 sm:w-72 ">
      <div
      ...
      <div
        ...
        <div className="mb-8">
          <div className="visible md:invisible text-gray-900 font-bold text-xl mb-2">{id} {summarizeText ? ' - ' + summarizeText : ''}</div>
